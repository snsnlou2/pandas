...
if TYPE_CHECKING:
    from pandas import Categorical, CategoricalIndex, DataFrame, DatetimeIndex, Float64Index, Index, Int64Index, IntervalIndex, MultiIndex, PeriodIndex, RangeIndex, Series, TimedeltaIndex, UInt64Index
    from pandas.core.arrays import DatetimeArray, ExtensionArray, PandasArray, PeriodArray, TimedeltaArray
...
ABCUInt64Index = cast('Type[UInt64Index]', create_pandas_abc_type('ABCUInt64Index', '_typ', ('uint64index',)))
ABCRangeIndex = cast('Type[RangeIndex]', create_pandas_abc_type('ABCRangeIndex', '_typ', ('rangeindex',)))
ABCFloat64Index = cast('Type[Float64Index]', create_pandas_abc_type('ABCFloat64Index', '_typ', ('float64index',)))
...
ABCIndex = cast('Type[Index]', create_pandas_abc_type('ABCIndex', '_typ', {'index', 'int64index', 'rangeindex', 'float64index', 'uint64index', 'multiindex', 'datetimeindex', 'timedeltaindex', 'periodindex', 'categoricalindex', 'intervalindex'}))
...
ABCPandasArray = cast('Type[PandasArray]', create_pandas_abc_type('ABCPandasArray', '_typ', ('npy_extension',)))
