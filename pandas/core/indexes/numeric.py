...
from pandas.core.dtypes.common import is_bool, is_bool_dtype, is_dtype_equal, is_extension_array_dtype, is_float, is_float_dtype, is_integer_dtype, is_number, is_numeric_dtype, is_scalar, is_signed_integer_dtype, is_unsigned_integer_dtype, needs_i8_conversion, pandas_dtype
...
_float64_descr_args = {'klass': 'Float64Index', 'dtype': 'float64', 'ltype': 'float', 'extra': ''}
...
class Float64Index(NumericIndex):
    ...
    def _format_native_types(self, na_rep='', float_format=None, decimal='.', quoting=None, **kwargs):
        ...
        formatter = FloatArrayFormatter(self._values, na_rep=na_rep, float_format=float_format, decimal=decimal, quoting=quoting, fixed_width=False)
