...
_format_params_doc = 'format : string\n    File format, only `xport` is currently supported.'
_iterator_doc = 'iterator : boolean, default False\n    Return XportReader object for reading file incrementally.'
...
class XportReader(ReaderBase, abc.Iterator):
    ...
    def __init__(self, filepath_or_buffer, index=None, encoding='ISO-8859-1', chunksize=None):
        ...
        self.handles = get_handle(filepath_or_buffer, 'rb', encoding=encoding, is_text=False)
