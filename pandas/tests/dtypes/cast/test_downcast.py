...
@pytest.mark.parametrize('arr,dtype,expected', [(np.array([8.5, 8.6, 8.7, 8.8, 8.9999999999995]), 'infer', np.array([8.5, 8.6, 8.7, 8.8, 8.9999999999995])), (np.array([8.0, 8.0, 8.0, 8.0, 8.9999999999995]), 'infer', np.array([8, 8, 8, 8, 9], dtype=np.int64)), (np.array([8.0, 8.0, 8.0, 8.0, 9.0000000000005]), 'infer', np.array([8, 8, 8, 8, 9], dtype=np.int64)), (np.array([decimal.Decimal(0.0)]), 'int64', np.array([decimal.Decimal(0.0)]))])
