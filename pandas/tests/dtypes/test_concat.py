...
@pytest.mark.parametrize('to_concat, expected', [([['a'], [1, 2]], ['i', 'object']), ([[3, 4], [1, 2]], ['i']), ([[3, 4], [1, 2.1]], ['i', 'f']), ([DatetimeIndex(['2011-01-01']), DatetimeIndex(['2011-01-02'])], ['datetime']), ([TimedeltaIndex(['1 days']), TimedeltaIndex(['2 days'])], ['timedelta']), ([DatetimeIndex(['2011-01-01']), DatetimeIndex(['2011-01-02'], tz='US/Eastern')], ['datetime', 'datetime64[ns, US/Eastern]']), ([DatetimeIndex(['2011-01-01'], tz='Asia/Tokyo'), DatetimeIndex(['2011-01-02'], tz='US/Eastern')], ['datetime64[ns, Asia/Tokyo]', 'datetime64[ns, US/Eastern]']), ([TimedeltaIndex(['1 days']), TimedeltaIndex(['2 hours'])], ['timedelta']), ([DatetimeIndex(['2011-01-01'], tz='Asia/Tokyo'), TimedeltaIndex(['1 days'])], ['datetime64[ns, Asia/Tokyo]', 'timedelta'])])
