...
class TestBuildSchema():
    ...
    def setup_method(self, method):
        self.df = DataFrame({'A': [1, 2, 3, 4], 'B': ['a', 'b', 'c', 'c'], 'C': pd.date_range('2016-01-01', freq='d', periods=4), 'D': pd.timedelta_range('1H', periods=4, freq='T')}, index=pd.Index(range(4), name='idx'))
...
class TestTableOrient():
    ...
    @pytest.mark.filterwarnings('ignore:an integer is required (got type float)*:DeprecationWarning')
    def test_to_json(self):
        ...
        data = [OrderedDict([('idx', 0), ('A', 1), ('B', 'a'), ('C', '2016-01-01T00:00:00.000Z'), ('D', 'P0DT1H0M0S'), ('E', 'a'), ('F', 'a'), ('G', 1.0), ('H', '2016-01-01T06:00:00.000Z')]), OrderedDict([('idx', 1), ('A', 2), ('B', 'b'), ('C', '2016-01-02T00:00:00.000Z'), ('D', 'P0DT1H1M0S'), ('E', 'b'), ('F', 'b'), ('G', 2.0), ('H', '2016-01-02T06:00:00.000Z')]), OrderedDict([('idx', 2), ('A', 3), ('B', 'c'), ('C', '2016-01-03T00:00:00.000Z'), ('D', 'P0DT1H2M0S'), ('E', 'c'), ('F', 'c'), ('G', 3.0), ('H', '2016-01-03T06:00:00.000Z')]), OrderedDict([('idx', 3), ('A', 4), ('B', 'c'), ('C', '2016-01-04T00:00:00.000Z'), ('D', 'P0DT1H3M0S'), ('E', 'c'), ('F', 'c'), ('G', 4.0), ('H', '2016-01-04T06:00:00.000Z')])]
    ...
    def test_mi_falsey_name(self):
        df = DataFrame(np.random.randn(4, 4), index=pd.MultiIndex.from_product([('A', 'B'), ('a', 'b')]))
...
class TestTableOrientReader():
    ...
    @pytest.mark.parametrize('vals', [{'timedeltas': pd.timedelta_range('1H', periods=4, freq='T')}])
