...
def missing_metadata():
    return [{'name': 'Alice', 'addresses': [{'number': 9562, 'street': 'Morris St.', 'city': 'Massillon', 'state': 'OH', 'zip': 44646}]}, {'addresses': [{'number': 8449, 'street': 'Spring St.', 'city': 'Elizabethton', 'state': 'TN', 'zip': 37643}]}]
...
class TestJSONNormalize():
    ...
    def test_non_ascii_key(self):
        testjson = (b'[{"\xc3\x9cnic\xc3\xb8de":0,"sub":{"A":1, "B":2}},' + b'{"\xc3\x9cnic\xc3\xb8de":1,"sub":{"A":3, "B":4}}]').decode('utf8')
