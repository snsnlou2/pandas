...
class TestPandasContainer():
    ...
    def test_roundtrip_intframe(self, orient, convert_axes, numpy, dtype, int_frame):
        ...
        result = pd.read_json(data, orient=orient, convert_axes=convert_axes, numpy=numpy, dtype=dtype)
        expected = int_frame
        if (numpy and ((not IS64) or is_platform_windows()) and (not dtype) and (orient != 'split')):
    ...
    def test_frame_mixedtype_orient(self):
    ...
    def test_mixed_timedelta_datetime(self):
        ...
        expected = DataFrame({'a': [pd.Timedelta(frame.a[0]).value, Timestamp(frame.a[1]).value]})
    ...
    def test_latin_encoding(self):
        ...
        values = [[b'E\xc9, 17', b'', b'a', b'b', b'c'], [b'E\xc9, 17', b'a', b'b', b'c'], [b'EE, 17', b'', b'a', b'b', b'c'], [b'E\xc9, 17', b'\xf8\xfc', b'a', b'b', b'c'], [b'', b'a', b'b', b'c'], [b'\xf8\xfc', b'a', b'b', b'c'], [b'A\xf8\xfc', b'', b'a', b'b', b'c'], [np.nan, b'', b'b', b'c'], [b'A\xf8\xfc', np.nan, b'', b'b', b'c']]
