...
def test_css_to_excel_good_colors(input_color, output_color):
    ...
    expected['border'] = {k: {'color': output_color} for k in ('top', 'right', 'bottom', 'left')}
