...
def _get_private_key_path():
    if _in_travis_environment():
        return os.path.join(*[os.environ.get('TRAVIS_BUILD_DIR'), 'ci', 'travis_gbq.json'])
...
class TestToGBQIntegrationWithServiceAccountKeyPath():
    ...
    @pytest.mark.parametrize('if_exists, expected_num_rows, expectation', [('append', 300, does_not_raise()), ('fail', 200, tm.external_error_raised(pandas_gbq.gbq.TableCreationError)), ('replace', 100, does_not_raise())])
