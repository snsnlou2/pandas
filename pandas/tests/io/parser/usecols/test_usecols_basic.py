...
@pytest.mark.parametrize('usecols,expected', [((lambda x: (x.upper() in ['AAA', 'BBB', 'DDD'])), DataFrame({'AaA': {0: 0.056674973, 1: 2.6132309819999997, 2: 3.5689350380000002}, 'bBb': {0: 8, 1: 2, 2: 7}, 'ddd': {0: 'a', 1: 'b', 2: 'a'}})), ((lambda x: False), DataFrame())])
