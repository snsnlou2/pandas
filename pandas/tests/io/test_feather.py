...
class TestFeather():
    ...
    def test_write_with_index(self):
        ...
        self.check_round_trip(df)
        msg = 'feather does not support serializing .* for the index; you can \\.reset_index\\(\\) to make the index into column\\(s\\)'
    ...
    def test_http_path(self, feather_file):
        url = 'https://raw.githubusercontent.com/pandas-dev/pandas/master/pandas/tests/io/data/feather/feather-0_3_1.feather'
