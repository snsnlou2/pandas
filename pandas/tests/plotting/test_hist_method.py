...
class TestDataFramePlots(TestPlotBase):
    ...
    def test_hist_df_legacy(self):
        ...
        df[2] = to_datetime(np.random.randint(self.start_date_to_int64, self.end_date_to_int64, size=100, dtype=np.int64))
        with tm.assert_produces_warning(UserWarning):
        ...
        df[5] = to_datetime(np.random.randint(self.start_date_to_int64, self.end_date_to_int64, size=100, dtype=np.int64))
        with tm.assert_produces_warning(UserWarning):
    ...
    def test_hist_non_numerical_or_datetime_raises(self):
        df = DataFrame({'a': np.random.rand(10), 'b': np.random.randint(0, 10, 10), 'c': to_datetime(np.random.randint(1582800000000000000, 1583500000000000000, 10, dtype=np.int64)), 'd': to_datetime(np.random.randint(1582800000000000000, 1583500000000000000, 10, dtype=np.int64), utc=True)})
    ...
    def test_hist_subplot_xrot(self):
        ...
        axes = _check_plot_works(df.hist, default_axes=True, filterwarnings='always', column='length', by='animal', bins=5, xrot=0)
...
class TestDataFrameGroupByPlots(TestPlotBase):
    ...
    def test_grouped_hist_legacy(self):
        ...
        df['B'] = to_datetime(np.random.randint(self.start_date_to_int64, self.end_date_to_int64, size=500, dtype=np.int64))
