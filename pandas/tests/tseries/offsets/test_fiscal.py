...
def test_get_offset():
    ...
    with pytest.raises(ValueError, match=INVALID_FREQ_ERR_MSG):
        with tm.assert_produces_warning(FutureWarning):
            get_offset('QS-JAN-B')
    pairs = [('RE-N-DEC-MON', makeFY5253NearestEndMonth(weekday=0, startingMonth=12)), ('RE-L-DEC-TUE', makeFY5253LastOfMonth(weekday=1, startingMonth=12)), ('REQ-L-MAR-TUE-4', makeFY5253LastOfMonthQuarter(weekday=1, startingMonth=3, qtr_with_extra_week=4)), ('REQ-L-DEC-MON-3', makeFY5253LastOfMonthQuarter(weekday=0, startingMonth=12, qtr_with_extra_week=3)), ('REQ-N-DEC-MON-3', makeFY5253NearestEndMonthQuarter(weekday=0, startingMonth=12, qtr_with_extra_week=3))]
