...
def _check_generated_range(start, periods, freq):
    ...
    if (not freq.startswith('Q-')):
        ...
        is_dec_range = ((inf_freq == 'Q-DEC') and (gen.freqstr in ('Q', 'Q-DEC', 'Q-SEP', 'Q-JUN', 'Q-MAR')))
        is_nov_range = ((inf_freq == 'Q-NOV') and (gen.freqstr in ('Q-NOV', 'Q-AUG', 'Q-MAY', 'Q-FEB')))
        is_oct_range = ((inf_freq == 'Q-OCT') and (gen.freqstr in ('Q-OCT', 'Q-JUL', 'Q-APR', 'Q-JAN')))
        assert (is_dec_range or is_nov_range or is_oct_range)

@pytest.fixture(params=[(timedelta(1), 'D'), (timedelta(hours=1), 'H'), (timedelta(minutes=1), 'T'), (timedelta(seconds=1), 'S'), (np.timedelta64(1, 'ns'), 'N'), (timedelta(microseconds=1), 'U'), (timedelta(microseconds=1000), 'L')])
...
@pytest.mark.parametrize('constructor', [(lambda now, delta: DatetimeIndex(([(now + (delta * 7))] + [(now + (delta * j)) for j in range(3)]))), (lambda now, delta: DatetimeIndex(([(now + (delta * j)) for j in range(3)] + [(now + (delta * 7))])))])
...
@pytest.mark.parametrize('expected,dates', list({'AS-JAN': ['2009-01-01', '2010-01-01', '2011-01-01', '2012-01-01'], 'Q-OCT': ['2009-01-31', '2009-04-30', '2009-07-31', '2009-10-31'], 'M': ['2010-11-30', '2010-12-31', '2011-01-31', '2011-02-28'], 'W-SAT': ['2010-12-25', '2011-01-01', '2011-01-08', '2011-01-15'], 'D': ['2011-01-01', '2011-01-02', '2011-01-03', '2011-01-04'], 'H': ['2011-12-31 22:00', '2011-12-31 23:00', '2012-01-01 00:00', '2012-01-01 01:00']}.items()))
...
@pytest.mark.parametrize('freq', ['3H', '10T', '3601S', '3600001L', '3600000001U', '3600000000001N'])
...
@pytest.mark.parametrize('data,expected', [(['2014-07-01 09:00', '2014-07-01 10:00', '2014-07-01 11:00', '2014-07-01 12:00', '2014-07-01 13:00', '2014-07-01 14:00'], 'H'), (['2014-07-01 09:00', '2014-07-01 10:00', '2014-07-01 11:00', '2014-07-01 12:00', '2014-07-01 13:00', '2014-07-01 14:00', '2014-07-01 15:00', '2014-07-01 16:00', '2014-07-02 09:00', '2014-07-02 10:00', '2014-07-02 11:00'], 'BH'), (['2014-07-04 09:00', '2014-07-04 10:00', '2014-07-04 11:00', '2014-07-04 12:00', '2014-07-04 13:00', '2014-07-04 14:00', '2014-07-04 15:00', '2014-07-04 16:00', '2014-07-07 09:00', '2014-07-07 10:00', '2014-07-07 11:00'], 'BH'), (['2014-07-04 09:00', '2014-07-04 10:00', '2014-07-04 11:00', '2014-07-04 12:00', '2014-07-04 13:00', '2014-07-04 14:00', '2014-07-04 15:00', '2014-07-04 16:00', '2014-07-07 09:00', '2014-07-07 10:00', '2014-07-07 11:00', '2014-07-07 12:00', '2014-07-07 13:00', '2014-07-07 14:00', '2014-07-07 15:00', '2014-07-07 16:00', '2014-07-08 09:00', '2014-07-08 10:00', '2014-07-08 11:00', '2014-07-08 12:00', '2014-07-08 13:00', '2014-07-08 14:00', '2014-07-08 15:00', '2014-07-08 16:00'], 'BH')])
...
@pytest.mark.parametrize('idx', [tm.makeIntIndex(10), tm.makeFloatIndex(10), tm.makePeriodIndex(10)])
def test_invalid_index_types(idx):
    msg = '(cannot infer freq from a non-convertible)|(Check the `freq` attribute instead of using infer_freq)'
    with pytest.raises(TypeError, match=msg):
...
@pytest.mark.parametrize('offset_func', [frequencies._get_offset, (lambda freq: date_range('2011-01-01', periods=5, freq=freq))])
