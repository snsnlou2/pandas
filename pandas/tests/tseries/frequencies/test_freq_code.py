...
@pytest.mark.parametrize('freqstr,exp_freqstr', [('D', 'D'), ('W', 'D'), ('M', 'D'), ('S', 'S'), ('T', 'S'), ('H', 'S')])
...
@pytest.mark.parametrize('freqstr,expected', [('A', 'year'), ('Q', 'quarter'), ('M', 'month'), ('D', 'day'), ('H', 'hour'), ('T', 'minute'), ('S', 'second'), ('L', 'millisecond'), ('U', 'microsecond'), ('N', 'nanosecond')])
...
@pytest.mark.parametrize('args,expected', [((1.5, 'T'), (90, 'S')), ((62.4, 'T'), (3744, 'S')), ((1.04, 'H'), (3744, 'S')), ((1, 'D'), (1, 'D')), ((0.342931, 'H'), (1234551600, 'U')), ((1.2345, 'D'), (106660800, 'L'))])
def test_resolution_bumping(args, expected):
    off = to_offset((str(args[0]) + args[1]))
    assert (off.n == expected[0])
    assert (off._prefix == expected[1])

@pytest.mark.parametrize('args', [(0.5, 'N'), (0.34293247987982695, 'H')])
def test_cat(args):
