...
class TestSeriesQuantile():
    ...
    @pytest.mark.parametrize('case', [[Timestamp('2011-01-01'), Timestamp('2011-01-02'), Timestamp('2011-01-03')], [Timestamp('2011-01-01', tz='US/Eastern'), Timestamp('2011-01-02', tz='US/Eastern'), Timestamp('2011-01-03', tz='US/Eastern')], [pd.Timedelta('1 days'), pd.Timedelta('2 days'), pd.Timedelta('3 days')], [Timestamp('2011-01-01'), Timestamp('2011-01-02'), Timestamp('2011-01-03'), pd.NaT], [Timestamp('2011-01-01', tz='US/Eastern'), Timestamp('2011-01-02', tz='US/Eastern'), Timestamp('2011-01-03', tz='US/Eastern'), pd.NaT], [pd.Timedelta('1 days'), pd.Timedelta('2 days'), pd.Timedelta('3 days'), pd.NaT]])
