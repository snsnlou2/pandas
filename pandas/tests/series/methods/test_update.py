...
class TestUpdate():
    ...
    @pytest.mark.parametrize('other, dtype, expected', [([61, 63], 'int32', Series([10, 61, 12], dtype='int32')), ([61, 63], 'int64', Series([10, 61, 12])), ([61, 63], float, Series([10.0, 61.0, 12.0])), ([61, 63], object, Series([10, 61, 12], dtype=object)), ([61.0, 63.0], 'int32', Series([10, 61, 12], dtype='int32')), ([61.0, 63.0], 'int64', Series([10, 61, 12])), ([61.0, 63.0], float, Series([10.0, 61.0, 12.0])), ([61.0, 63.0], object, Series([10, 61.0, 12], dtype=object)), ([61.1, 63.1], 'int32', Series([10.0, 61.1, 12.0])), ([61.1, 63.1], 'int64', Series([10.0, 61.1, 12.0])), ([61.1, 63.1], float, Series([10.0, 61.1, 12.0])), ([61.1, 63.1], object, Series([10, 61.1, 12], dtype=object)), ([(61,), (63,)], 'int32', Series([10, (61,), 12])), ([(61,), (63,)], 'int64', Series([10, (61,), 12])), ([(61,), (63,)], float, Series([10.0, (61,), 12.0])), ([(61,), (63,)], object, Series([10, (61,), 12]))])
