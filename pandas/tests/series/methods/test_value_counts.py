...
class TestSeriesValueCounts():
    ...
    @pytest.mark.parametrize('ser, dropna, exp', [(Series([False, True, True, pd.NA]), False, Series([2, 1, 1], index=[True, pd.NA, False])), (Series([False, True, True, pd.NA]), True, Series([2, 1], index=[True, False])), (Series(range(3), index=[True, False, np.nan]).index, False, Series([1, 1, 1], index=[pd.NA, False, True]))])
