...
from pandas import NA, Categorical, CategoricalDtype, Index, Interval, NaT, Series, Timedelta, Timestamp, cut, date_range
...
class TestAstype():
    ...
    def test_astype_dt64tz_to_str(self):
        ...
        expected = Series(['2012-01-01 00:00:00-05:00', '2012-01-02 00:00:00-05:00', '2012-01-03 00:00:00-05:00'], dtype=object)
        tm.assert_series_equal(result, expected)
    ...
    @pytest.mark.parametrize('values', [Series(['x', 'y', 'z'], dtype='string'), Series(['x', 'y', 'z'], dtype='category'), Series((3 * [Timestamp('2020-01-01', tz='UTC')])), Series((3 * [Interval(0, 1)]))])
