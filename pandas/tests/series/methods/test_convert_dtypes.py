...
class TestSeriesConvertDtypes():
    ...
    def test_convert_string_dtype(self):
        df = pd.DataFrame({'A': ['a', 'b', pd.NA], 'B': ['ä', 'ö', 'ü']}, dtype='string')
