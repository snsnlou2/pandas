...
import pandas as pd
from pandas import Categorical, DataFrame, DatetimeIndex, Index, Series, Timestamp, date_range, period_range
...
def test_getitem_ndim_deprecated(series):
    with tm.assert_produces_warning(FutureWarning, match='Support for multi-dimensional indexing'):
        result = series[:, None]
