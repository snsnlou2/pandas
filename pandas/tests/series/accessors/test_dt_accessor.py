...
import pandas as pd
from pandas import DataFrame, DatetimeIndex, Index, Period, PeriodIndex, Series, TimedeltaIndex, date_range, period_range, timedelta_range
...
class TestSeriesDatetimeValues():
    ...
    def test_dt_namespace_accessor(self):
        ...
        ok_for_dt_methods = ['to_period', 'to_pydatetime', 'tz_localize', 'tz_convert', 'normalize', 'strftime', 'round', 'floor', 'ceil', 'day_name', 'month_name', 'isocalendar']
    ...
    def test_isocalendar(self, input_series, expected_output):
        ...
        expected_frame = pd.DataFrame(expected_output, columns=['year', 'week', 'day'], dtype='UInt32')
