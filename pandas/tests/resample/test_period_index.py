...
class TestPeriodIndex():
    ...
    def test_resample_basic(self):
        ...
        s[10:30] = np.nan
        index = PeriodIndex([Period('2013-01-01 00:00', 'T'), Period('2013-01-01 00:01', 'T')], name='idx')
    ...
    def test_resample_with_pytz(self):
        ...
        expected = Series(2, index=pd.DatetimeIndex(['2017-01-01', '2017-01-02'], tz='US/Eastern', freq='D'))
        tm.assert_series_equal(result, expected)
    ...
    def test_resample_nonexistent_time_bin_edge(self):
        ...
        expected = date_range(start='2017-10-09', end='2017-10-20', freq='D', tz='America/Sao_Paulo', nonexistent='shift_forward', closed='left')
    ...
    def test_resample_tz_localized(self):
        ...
        expected = DataFrame({'first': ts.resample('A').sum()['first'], 'second': ts.resample('A').mean()['second']}, columns=['first', 'second'])
