...
@pytest.mark.parametrize('name, func', [('Int64Index', tm.makeIntIndex), ('Index', tm.makeUnicodeIndex), ('Float64Index', tm.makeFloatIndex), ('MultiIndex', (lambda m: tm.makeCustomIndex(m, 2)))])
...
def test_repr():
    ...
    expected = "TimeGrouper(key='A', freq=<Hour>, axis=0, sort=True, closed='left', label='left', how='mean', convention='e', origin='start_day')"
    assert (result == expected)
    result = repr(Grouper(key='A', freq='H', origin='2000-01-01'))
    expected = "TimeGrouper(key='A', freq=<Hour>, axis=0, sort=True, closed='left', label='left', how='mean', convention='e', origin=Timestamp('2000-01-01 00:00:00'))"
    assert (result == expected)
...
def test_upsample_sum(method, method_args, expected_values):
    ...
    index = pd.DatetimeIndex(['2017-01-01T00:00:00', '2017-01-01T00:30:00', '2017-01-01T01:00:00'], freq='30T')
