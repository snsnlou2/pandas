...
@pytest.fixture(params=[StringDtype, pytest.param(ArrowStringDtype, marks=td.skip_if_no('pyarrow', min_version='1.0.0'))])
def dtype(request):
...
def data_for_grouping(dtype):
    return dtype.construct_array_type()._from_sequence(['B', 'B', pd.NA, pd.NA, 'A', 'A', 'B', 'C'])
