...
@pytest.mark.parametrize('times', [np.arange(10).astype('datetime64[D]').astype('datetime64[ns]'), date_range('2000', freq='D', periods=10), date_range('2000', freq='D', periods=10).tz_localize('UTC'), 'time_col'])
