...
@pytest.mark.parametrize('freqstr', ['2h20m', 'U1', '-U', '3U1', '-2-3U', '-2D:3H', '1.5.0S', '2SMS-15-15', '2SMS-15D', '100foo', '+-1d', '-+1h', '+1', '-7', '+d', '-m', 'SM-0', 'SM-28', 'SM-29', 'SM-FOO', 'BSM', 'SM--1', 'SMS-1', 'SMS-28', 'SMS-30', 'SMS-BAR', 'SMS-BYR', 'BSMS', 'SMS--2'])
