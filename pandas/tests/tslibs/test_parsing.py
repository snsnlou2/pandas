...
@pytest.mark.parametrize('date_str,freq,expected', [('2013Q2', None, datetime(2013, 4, 1)), ('2013Q2', 'A-APR', datetime(2012, 8, 1)), ('2013-Q2', 'A-DEC', datetime(2013, 4, 1))])
...
@pytest.mark.parametrize('string,fmt', [('20111230', '%Y%m%d'), ('2011-12-30', '%Y-%m-%d'), ('30-12-2011', '%d-%m-%Y'), ('2011-12-30 00:00:00', '%Y-%m-%d %H:%M:%S'), ('2011-12-30T00:00:00', '%Y-%m-%dT%H:%M:%S'), ('2011-12-30 00:00:00.000000', '%Y-%m-%d %H:%M:%S.%f')])
...
@pytest.mark.parametrize('invalid_dt', ['2013', '01/2013', '12:00:00', '1/1/1/1', 'this_is_not_a_datetime', '51a', 9, datetime(2011, 1, 1)])
def test_guess_datetime_format_invalid_inputs(invalid_dt):
    assert (parsing.guess_datetime_format(invalid_dt) is None)

@pytest.mark.parametrize('string,fmt', [('2011-1-1', '%Y-%m-%d'), ('1/1/2011', '%m/%d/%Y'), ('30-1-2011', '%d-%m-%Y'), ('2011-1-1 0:0:0', '%Y-%m-%d %H:%M:%S'), ('2011-1-3T00:00:0', '%Y-%m-%dT%H:%M:%S'), ('2011-1-1 00:00:00', '%Y-%m-%d %H:%M:%S')])
