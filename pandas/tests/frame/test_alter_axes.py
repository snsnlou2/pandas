...
import pytest
import pytz
from pandas.core.dtypes.common import is_categorical_dtype, is_interval_dtype, is_object_dtype
from pandas import DataFrame, DatetimeIndex, Index, IntervalIndex, Series, Timestamp, cut, date_range
...
class TestDataFrameAlterAxes():
    ...
    def idx_expected(self):
        idx = DatetimeIndex(['2013-1-1 13:00', '2013-1-2 14:00'], name='B').tz_localize('US/Pacific')
