...
class TestRename():
    ...
    def test_rename_mi(self, klass):
        obj = klass([11, 21, 31], index=MultiIndex.from_tuples([('A', x) for x in ['a', 'B', 'c']]))
    ...
    @pytest.mark.parametrize('args,kwargs', [((ChainMap({'A': 'a'}, {'B': 'b'}),), {'axis': 'columns'}), ((), {'columns': ChainMap({'A': 'a'}, {'B': 'b'})})])
    ...
    def test_rename_multiindex(self):
        ...
        renamed = df.rename(index={'foo1': 'foo3', 'bar2': 'bar3'}, columns={'fizz1': 'fizz3', 'buzz2': 'buzz3'})
