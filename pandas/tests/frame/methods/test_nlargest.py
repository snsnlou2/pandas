...
class TestNLargestNSmallest():
    ...
    def test_nlargest_n(self, df_strings, nselect_method, n, order):
        df = df_strings
        if ('b' in order):
            error_msg = f"Column 'b' has dtype object, cannot use method '{nselect_method}' with this dtype"
