...
class TestArithmetic():
    ...
    def test_objarr_radd_str_invalid(self, dtype, data, box_with_array):
        ...
        ser = tm.box_expected(ser, box_with_array)
        msg = 'can only concatenate str|did not contain a loop with signature matching types|unsupported operand type|must be str'
    ...
    def test_series_with_dtype_radd_timedelta(self, dtype):
        ...
        expected = Series([pd.Timedelta('4 days'), pd.Timedelta('5 days'), pd.Timedelta('6 days')])
