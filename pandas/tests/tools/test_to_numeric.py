...
def test_downcast_empty(dc1, dc2):
    tm.assert_numpy_array_equal(pd.to_numeric([], downcast=dc1), pd.to_numeric([], downcast=dc2), check_dtype=False)
...
@pytest.mark.parametrize('values, expected', [(['1', '2', None], Series([1, 2, np.nan])), (['1', '2', '3'], Series([1, 2, 3])), (['1', '2', 3], Series([1, 2, 3])), (['1', '2', 3.5], Series([1, 2, 3.5])), (['1', None, 3.5], Series([1, np.nan, 3.5])), (['1', '2', '3.5'], Series([1, 2, 3.5]))])
