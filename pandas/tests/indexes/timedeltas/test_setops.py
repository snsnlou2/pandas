...
class TestTimedeltaIndex():
    ...
    @pytest.mark.parametrize('rng, expected', [(timedelta_range('1 day', periods=5, freq='h', name='idx'), timedelta_range('1 day', periods=4, freq='h', name='idx')), (timedelta_range('1 day', periods=5, freq='h', name='other'), timedelta_range('1 day', periods=4, freq='h', name=None)), (timedelta_range('1 day', periods=10, freq='h', name='idx')[5:], TimedeltaIndex([], freq='h', name='idx'))])
