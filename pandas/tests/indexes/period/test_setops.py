...
class TestPeriodIndex():
    ...
    def test_union(self, sort):
        ...
        expected5 = PeriodIndex(['2000-01-01 09:01', '2000-01-01 09:03', '2000-01-01 09:05', '2000-01-01 09:08'], freq='T')
        ...
        expected7 = PeriodIndex(['2003', '2004', '2005', '2006', '2007', '1998', '1999', '2000', '2001', '2002'], freq='A')
    ...
    def test_union_misc(self, sort):
        ...
        msg = 'Input has different freq=W-WED from PeriodIndex\\(freq=D\\)'
    ...
    def test_intersection(self, sort):
        ...
        msg = 'Input has different freq=2D from PeriodIndex\\(freq=D\\)'
        with pytest.raises(IncompatibleFrequency, match=msg):
