...
import pandas as pd
from pandas import DataFrame, DatetimeIndex, Index, NaT, Period, PeriodIndex, Series, date_range, offsets, period_range
...
class TestPeriodIndex(DatetimeLike):
    ...
    @pytest.mark.parametrize('index', [period_range('2000-01-01', periods=3, freq='D'), period_range('2001-01-01', periods=3, freq='2D'), PeriodIndex(['2001-01', 'NaT', '2003-01'], freq='M')])
    ...
    def _check_all_fields(self, periodindex):
        fields = ['year', 'month', 'day', 'hour', 'minute', 'second', 'weekofyear', 'week', 'dayofweek', 'day_of_week', 'dayofyear', 'day_of_year', 'quarter', 'qyear', 'days_in_month']
