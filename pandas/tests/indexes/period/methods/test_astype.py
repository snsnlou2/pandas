...
import numpy as np
import pytest
from pandas import CategoricalIndex, DatetimeIndex, Index, Int64Index, NaT, Period, PeriodIndex, Timedelta, UInt64Index, period_range
...
class TestPeriodIndexAsType():
    ...
    def test_astype_conversion(self):
        ...
        expected = Int64Index(([16937] + ([(- 9223372036854775808)] * 3)), dtype=np.int64, name='idx')
        tm.assert_index_equal(result, expected)
