...
class TestArithmetic():
    ...
    @pytest.mark.parametrize('klass', [Float64Index, Int64Index, UInt64Index, RangeIndex])
...
class TestNumericIndex():
    ...
    def test_index_groupby(self):
        ...
        for idx in [int_idx, float_idx, obj_idx, dt_idx]:
            ...
            to_groupby = pd.DatetimeIndex([datetime(2011, 11, 1), datetime(2011, 12, 1), pd.NaT, pd.NaT, datetime(2011, 12, 1), datetime(2011, 11, 1)], tz='UTC').values
...
class TestFloat64Index(Numeric):
    ...
    @pytest.mark.parametrize('index, dtype', [(Int64Index, 'float64'), (UInt64Index, 'categorical'), (Float64Index, 'datetime64'), (RangeIndex, 'float64')])
    ...
    @pytest.mark.parametrize('other', (Int64Index([1, 2]), Index([1.0, 2.0], dtype=object), Index([1, 2], dtype=object)))
...
def test_uint_index_does_not_convert_to_float64(box):
    ...
    expected = UInt64Index([7606741985629028552, 17876870360202815256, 17876870360202815256], dtype='uint64')
