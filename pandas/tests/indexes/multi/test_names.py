...
def test_names(idx, index_names):
    ...
    with pytest.raises(ValueError, match='^Length of names'):
        MultiIndex(levels=[major_axis, minor_axis], codes=[major_codes, minor_codes], names=['first'])
    with pytest.raises(ValueError, match='^Length of names'):
        MultiIndex(levels=[major_axis, minor_axis], codes=[major_codes, minor_codes], names=['first', 'second', 'third'])
    index.names = ['a', 'b']
