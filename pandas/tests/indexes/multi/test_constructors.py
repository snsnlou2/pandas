...
def test_create_index_existing_name(idx):
    ...
    index.names = ['foo', 'bar']
    result = Index(index)
    expected = Index(Index([('foo', 'one'), ('foo', 'two'), ('bar', 'one'), ('baz', 'two'), ('qux', 'one'), ('qux', 'two')], dtype='object'))
    tm.assert_index_equal(result, expected)
    result = Index(index, name='A')
    expected = Index(Index([('foo', 'one'), ('foo', 'two'), ('bar', 'one'), ('baz', 'two'), ('qux', 'one'), ('qux', 'two')], dtype='object'), name='A')
    tm.assert_index_equal(result, expected)
