...
class TestRangeIndexConstructors():
    ...
    @pytest.mark.parametrize('args, kwargs, start, stop, step', [((5,), {}, 0, 5, 1), ((1, 5), {}, 1, 5, 1), ((1, 5, 2), {}, 1, 5, 2), ((0,), {}, 0, 0, 1), ((0, 0), {}, 0, 0, 1), ((), {'start': 0}, 0, 0, 1), ((), {'stop': 0}, 0, 0, 1)])
    ...
    def test_constructor_corner(self):
        ...
        with pytest.raises(TypeError, match="Wrong type \\<class 'str'\\>"):
            RangeIndex('1', '10', '1')
        with pytest.raises(TypeError, match="Wrong type \\<class 'float'\\>"):
