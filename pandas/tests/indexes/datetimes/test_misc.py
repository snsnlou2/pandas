...
class TestTimeSeries():
    ...
    def test_range_edges(self):
        idx = date_range(start=Timestamp('1970-01-01 00:00:00.000000001'), end=Timestamp('1970-01-01 00:00:00.000000004'), freq='N')
        exp = DatetimeIndex(['1970-01-01 00:00:00.000000001', '1970-01-01 00:00:00.000000002', '1970-01-01 00:00:00.000000003', '1970-01-01 00:00:00.000000004'], freq='N')
        tm.assert_index_equal(idx, exp)
        idx = date_range(start=Timestamp('1970-01-01 00:00:00.000000004'), end=Timestamp('1970-01-01 00:00:00.000000001'), freq='N')
        exp = DatetimeIndex([], freq='N')
        tm.assert_index_equal(idx, exp)
        idx = date_range(start=Timestamp('1970-01-01 00:00:00.000000001'), end=Timestamp('1970-01-01 00:00:00.000000001'), freq='N')
        exp = DatetimeIndex(['1970-01-01 00:00:00.000000001'], freq='N')
        tm.assert_index_equal(idx, exp)
        idx = date_range(start=Timestamp('1970-01-01 00:00:00.000001'), end=Timestamp('1970-01-01 00:00:00.000004'), freq='U')
        exp = DatetimeIndex(['1970-01-01 00:00:00.000001', '1970-01-01 00:00:00.000002', '1970-01-01 00:00:00.000003', '1970-01-01 00:00:00.000004'], freq='U')
        tm.assert_index_equal(idx, exp)
        idx = date_range(start=Timestamp('1970-01-01 00:00:00.001'), end=Timestamp('1970-01-01 00:00:00.004'), freq='L')
        exp = DatetimeIndex(['1970-01-01 00:00:00.001', '1970-01-01 00:00:00.002', '1970-01-01 00:00:00.003', '1970-01-01 00:00:00.004'], freq='L')
        tm.assert_index_equal(idx, exp)
        idx = date_range(start=Timestamp('1970-01-01 00:00:01'), end=Timestamp('1970-01-01 00:00:04'), freq='S')
        exp = DatetimeIndex(['1970-01-01 00:00:01', '1970-01-01 00:00:02', '1970-01-01 00:00:03', '1970-01-01 00:00:04'], freq='S')
        tm.assert_index_equal(idx, exp)
        idx = date_range(start=Timestamp('1970-01-01 00:01'), end=Timestamp('1970-01-01 00:04'), freq='T')
        exp = DatetimeIndex(['1970-01-01 00:01', '1970-01-01 00:02', '1970-01-01 00:03', '1970-01-01 00:04'], freq='T')
        tm.assert_index_equal(idx, exp)
        idx = date_range(start=Timestamp('1970-01-01 01:00'), end=Timestamp('1970-01-01 04:00'), freq='H')
        exp = DatetimeIndex(['1970-01-01 01:00', '1970-01-01 02:00', '1970-01-01 03:00', '1970-01-01 04:00'], freq='H')
        tm.assert_index_equal(idx, exp)
        idx = date_range(start=Timestamp('1970-01-01'), end=Timestamp('1970-01-04'), freq='D')
        exp = DatetimeIndex(['1970-01-01', '1970-01-02', '1970-01-03', '1970-01-04'], freq='D')
        tm.assert_index_equal(idx, exp)
...
def test_isocalendar_returns_correct_values_close_to_new_year_with_tz():
    ...
    expected_data_frame = pd.DataFrame([[2013, 52, 7], [2014, 1, 1], [2014, 1, 2]], columns=['year', 'week', 'day'], index=dates, dtype='UInt32')
