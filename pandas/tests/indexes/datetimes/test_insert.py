...
class TestInsert():
    ...
    def test_insert(self):
        ...
        expected = Index([datetime(2000, 1, 4), 'inserted', datetime(2000, 1, 1), datetime(2000, 1, 2)], name='idx')
        assert (not isinstance(result, DatetimeIndex))
        tm.assert_index_equal(result, expected)
        assert (result.name == expected.name)
        idx = date_range('1/1/2000', periods=3, freq='M', name='idx')
        expected_0 = DatetimeIndex(['1999-12-31', '2000-01-31', '2000-02-29', '2000-03-31'], name='idx', freq='M')
        expected_3 = DatetimeIndex(['2000-01-31', '2000-02-29', '2000-03-31', '2000-04-30'], name='idx', freq='M')
        expected_1_nofreq = DatetimeIndex(['2000-01-31', '2000-01-31', '2000-02-29', '2000-03-31'], name='idx', freq=None)
        expected_3_nofreq = DatetimeIndex(['2000-01-31', '2000-02-29', '2000-03-31', '2000-01-02'], name='idx', freq=None)
        ...
        expected = DatetimeIndex(['2000-01-31', '2000-02-29', '2000-03-31', '2000-01-02'], name='idx', freq=None)
        tm.assert_index_equal(result, expected)
        assert (result.name == expected.name)
        assert (result.freq is None)
        ...
        for tz in ['US/Pacific', 'Asia/Singapore']:
            ...
            expected = DatetimeIndex(['2000-01-01 09:00', '2000-01-01 10:00', '2000-01-01 11:00', '2000-01-01 12:00', '2000-01-01 13:00', '2000-01-01 14:00', '2000-01-01 10:00'], name='idx', tz=tz, freq=None)
