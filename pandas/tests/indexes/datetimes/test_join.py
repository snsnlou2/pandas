...
class TestJoin():
    ...
    def test_does_not_convert_mixed_integer(self):
        df = tm.makeCustomDataframe(10, 10, data_gen_f=(lambda *args, **kwargs: np.random.randn()), r_idx_type='i', c_idx_type='dt')
    ...
    def test_join_with_period_index(self, join_type):
        df = tm.makeCustomDataframe(10, 10, data_gen_f=(lambda *args: np.random.randint(2)), c_idx_type='p', r_idx_type='dt')
        s = df.iloc[:5, 0]
