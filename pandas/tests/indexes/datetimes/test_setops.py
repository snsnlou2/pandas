...
import pandas as pd
from pandas import DataFrame, DatetimeIndex, Index, Int64Index, Series, bdate_range, date_range
...
class TestBusinessDatetimeIndex():
    ...
    def test_intersection_duplicates(self, sort):
        idx1 = Index([pd.Timestamp('2019-12-13'), pd.Timestamp('2019-12-12'), pd.Timestamp('2019-12-12')])
