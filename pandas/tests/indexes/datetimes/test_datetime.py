...
class TestDatetimeIndex():
    ...
    @pytest.mark.parametrize('arr, expected', [(DatetimeIndex(['2017', '2017']), DatetimeIndex(['2017'])), (DatetimeIndex(['2017', '2017'], tz='US/Eastern'), DatetimeIndex(['2017'], tz='US/Eastern'))])
