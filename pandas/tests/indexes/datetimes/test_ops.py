...
import pandas as pd
from pandas import DateOffset, DatetimeIndex, Index, Series, Timestamp, bdate_range, date_range
...
class TestDatetimeIndexOps():
    ...
    def test_repeat_range(self, tz_naive_fixture):
        ...
        exp = DatetimeIndex(['2001-01-01', '2001-01-01', '2001-01-01', 'NaT', 'NaT', 'NaT', '2003-01-01', '2003-01-01', '2003-01-01'], tz=tz)
    ...
    @pytest.mark.parametrize('freq,expected', [('A', 'day'), ('Q', 'day'), ('M', 'day'), ('D', 'day'), ('H', 'hour'), ('T', 'minute'), ('S', 'second'), ('L', 'millisecond'), ('U', 'microsecond')])
    ...
    @pytest.mark.parametrize('keep, expected, index', [('first', np.concatenate((([False] * 10), ([True] * 5))), np.arange(0, 10)), ('last', np.concatenate((([True] * 5), ([False] * 10))), np.arange(5, 15)), (False, np.concatenate((([True] * 5), ([False] * 5), ([True] * 5))), np.arange(5, 10))])
