...
class TestDatetimeIndexShift():
    ...
    def test_dti_shift_tzaware(self, tz_naive_fixture):
        ...
        idx = DatetimeIndex(['2011-01-01 10:00', '2011-01-01 11:00', '2011-01-01 12:00'], name='xxx', tz=tz, freq='H')
        tm.assert_index_equal(idx.shift(0, freq='H'), idx)
        exp = DatetimeIndex(['2011-01-01 13:00', '2011-01-01 14:00', '2011-01-01 15:00'], name='xxx', tz=tz, freq='H')
        tm.assert_index_equal(idx.shift(3, freq='H'), exp)
        exp = DatetimeIndex(['2011-01-01 07:00', '2011-01-01 08:00', '2011-01-01 09:00'], name='xxx', tz=tz, freq='H')
        tm.assert_index_equal(idx.shift((- 3), freq='H'), exp)

    def test_dti_shift_freqs(self):
        drange = date_range('20130101', periods=5)
        result = drange.shift(1)
        expected = DatetimeIndex(['2013-01-02', '2013-01-03', '2013-01-04', '2013-01-05', '2013-01-06'], freq='D')
        tm.assert_index_equal(result, expected)
        result = drange.shift((- 1))
        expected = DatetimeIndex(['2012-12-31', '2013-01-01', '2013-01-02', '2013-01-03', '2013-01-04'], freq='D')
        tm.assert_index_equal(result, expected)
        result = drange.shift(3, freq='2D')
        expected = DatetimeIndex(['2013-01-07', '2013-01-08', '2013-01-09', '2013-01-10', '2013-01-11'], freq='D')
        tm.assert_index_equal(result, expected)
