...
class TestDatetimeIndex():
    ...
    def test_constructor_datetime64_tzformat(self, freq):
        ...
        expected = date_range('2013-01-01T00:00:00', '2016-01-01T23:59:59', freq=freq, tz=pytz.FixedOffset((- 300)))
        ...
        expected = date_range('2013-01-01T00:00:00', '2016-01-01T23:59:59', freq=freq, tz=pytz.FixedOffset(540))
        tm.assert_index_equal(idx, expected)
    ...
    def test_constructor_start_end_with_tz(self, tz):
        ...
        expected = DatetimeIndex(['2013-01-01 06:00:00', '2013-01-02 06:00:00'], tz='America/Los_Angeles', freq='D')
        tm.assert_index_equal(result, expected)
    ...
    def test_construction_from_replaced_timestamps_with_dst(self):
        index = date_range(Timestamp(2000, 1, 1), Timestamp(2005, 1, 1), freq='MS', tz='Australia/Melbourne')
...
class TestTimeSeries():
    ...
    def test_dti_constructor_years_only(self, tz_naive_fixture):
        ...
        for (rng, expected) in [(rng1, expected1), (rng2, expected2), (rng3, expected3), (rng4, expected4)]:
...
@pytest.mark.parametrize('tz', ['dateutil/Europe/London'])
@pytest.mark.parametrize('ts_input,fold,value_out', [(datetime(2019, 10, 27, 1, 30, 0, 0), 0, 1572136200000000000), (datetime(2019, 10, 27, 1, 30, 0, 0), 1, 1572139800000000000)])
