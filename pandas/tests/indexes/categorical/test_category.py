...
class TestCategoricalIndex(Base):
    ...
    @pytest.mark.parametrize('data, categories, expected_data, expected_categories', [([1, 1, 1], [1, 2, 3], [1], [1]), ([1, 1, 1], list('abc'), [np.nan], []), ([1, 2, 'a'], [1, 2, 3], [1, 2, np.nan], [1, 2]), ([2, 'a', 'b'], list('abc'), [np.nan, 'a', 'b'], ['a', 'b'])])
