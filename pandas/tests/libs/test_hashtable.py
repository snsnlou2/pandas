...
@pytest.mark.parametrize('dtype, type_suffix', [(np.object_, 'object'), (np.complex128, 'complex128'), (np.int64, 'int64'), (np.uint64, 'uint64'), (np.float64, 'float64'), (np.complex64, 'complex64'), (np.int32, 'int32'), (np.uint32, 'uint32'), (np.float32, 'float32'), (np.int16, 'int16'), (np.uint16, 'uint16'), (np.int8, 'int8'), (np.uint8, 'uint8')])
...
@pytest.mark.parametrize('dtype, type_suffix', [(np.float64, 'float64'), (np.float32, 'float32'), (np.complex128, 'complex128'), (np.complex64, 'complex64')])
