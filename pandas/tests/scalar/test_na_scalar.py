...
@pytest.mark.parametrize('value', [0, 0.0, (- 0), (- 0.0), False, np.bool_(False), np.int_(0), np.float_(0), np.int_((- 0)), np.float_((- 0))])
...
@pytest.mark.parametrize('values, dtype', [([1, 2, pd.NA], 'Int64'), (['A', 'B', pd.NA], 'string')])
