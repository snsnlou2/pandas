...
class TestTimedeltas():
    ...
    @pytest.mark.parametrize('unit, np_unit', (((((([(value, 'W') for value in ['W', 'w']] + [(value, 'D') for value in ['D', 'd', 'days', 'day', 'Days', 'Day']]) + [(value, 'm') for value in ['m', 'minute', 'min', 'minutes', 't', 'Minute', 'Min', 'Minutes', 'T']]) + [(value, 's') for value in ['s', 'seconds', 'sec', 'second', 'S', 'Seconds', 'Sec', 'Second']]) + [(value, 'ms') for value in ['ms', 'milliseconds', 'millisecond', 'milli', 'millis', 'l', 'MS', 'Milliseconds', 'Millisecond', 'Milli', 'Millis', 'L']]) + [(value, 'us') for value in ['us', 'microseconds', 'microsecond', 'micro', 'micros', 'u', 'US', 'Microseconds', 'Microsecond', 'Micro', 'Micros', 'U']]) + [(value, 'ns') for value in ['ns', 'nanoseconds', 'nanosecond', 'nano', 'nanos', 'n', 'NS', 'Nanoseconds', 'Nanosecond', 'Nano', 'Nanos', 'N']]))
...
@pytest.mark.parametrize('value, expected', [(Timedelta('10S'), True), (Timedelta('-10S'), True), (Timedelta(10, unit='ns'), True), (Timedelta(0, unit='ns'), False), (Timedelta((- 10), unit='ns'), True), (Timedelta(None), True), (NaT, True)])
