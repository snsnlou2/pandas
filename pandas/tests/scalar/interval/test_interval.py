...
class TestInterval():
    ...
    @pytest.mark.parametrize('left, right, expected', [(0, 5, 5), ((- 2), 5.5, 7.5), (10, 10, 0), (10, np.inf, np.inf), ((- np.inf), (- 5), np.inf), ((- np.inf), np.inf, np.inf), (Timedelta('0 days'), Timedelta('5 days'), Timedelta('5 days')), (Timedelta('10 days'), Timedelta('10 days'), Timedelta('0 days')), (Timedelta('1H10min'), Timedelta('5H5min'), Timedelta('3H55min')), (Timedelta('5S'), Timedelta('1H'), Timedelta('59min55S'))])
