...
import pandas as pd
from pandas import Index, Interval, IntervalIndex, Timedelta, Timestamp, date_range, timedelta_range
...
@pyarrow_skip
@pytest.mark.parametrize('breaks', [[0.0, 1.0, 2.0, 3.0], pd.date_range('2017', periods=4, freq='D')], ids=['float', 'datetime64[ns]'])
