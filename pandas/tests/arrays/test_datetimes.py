...
class TestDatetimeArray():
    ...
    def test_array_interface(self):
        ...
        tm.assert_numpy_array_equal(result, expected)
        result = np.asarray(data, dtype=object)
        expected = np.array([pd.Timestamp('2017-01-01T00:00:00'), pd.Timestamp('2017-01-02T00:00:00')], dtype=object)
        tm.assert_numpy_array_equal(result, expected)
...
class TestReductions():
    ...
    def arr1d(self, tz_naive_fixture):
        ...
        arr = DatetimeArray._from_sequence(['2000-01-03', '2000-01-03', 'NaT', '2000-01-02', '2000-01-05', '2000-01-04'], dtype=dtype)
        return arr
