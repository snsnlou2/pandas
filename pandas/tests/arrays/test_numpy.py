...
@pytest.mark.parametrize('dtype, expected', [('bool', True), ('int', True), ('uint', True), ('float', True), ('complex', True), ('str', False), ('bytes', False), ('datetime64[ns]', False), ('object', False), ('void', False)])
def test_is_numeric(dtype, expected):
    dtype = PandasDtype(dtype)
    assert (dtype._is_numeric is expected)

@pytest.mark.parametrize('dtype, expected', [('bool', True), ('int', False), ('uint', False), ('float', False), ('complex', False), ('str', False), ('bytes', False), ('datetime64[ns]', False), ('object', False), ('void', False)])
