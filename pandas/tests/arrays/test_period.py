...
@pytest.mark.parametrize('data, freq, msg', [([pd.Period('2017', 'D'), pd.Period('2017', 'A')], None, 'Input has different freq'), ([pd.Period('2017', 'D')], 'A', 'Input has different freq')])
...
@pytest.mark.parametrize('key, value, expected', [([0], pd.Period('2000', 'D'), [10957, 1, 2]), ([0], None, [iNaT, 1, 2]), ([0], np.nan, [iNaT, 1, 2]), ([0, 1, 2], pd.Period('2000', 'D'), ([10957] * 3)), ([0, 1, 2], [pd.Period('2000', 'D'), pd.Period('2001', 'D'), pd.Period('2002', 'D')], [10957, 11323, 11688])])
...
@pytest.mark.parametrize('other', [pd.Period('2000', freq='H'), period_array(['2000', '2001', '2000'], freq='H')])
...
class TestReductions():
    ...
    def test_min_max(self):
        arr = period_array(['2000-01-03', '2000-01-03', 'NaT', '2000-01-02', '2000-01-05', '2000-01-04'], freq='D')
        result = arr.min()
...
@pyarrow_skip
@pytest.mark.parametrize('data, freq', [(pd.date_range('2017', periods=3), 'D'), (pd.date_range('2017', periods=3, freq='A'), 'A-DEC')])
