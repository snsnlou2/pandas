...
class TestComparisonOps(BaseOpsUtil):
    ...
    def test_array(self, all_compare_operators):
        ...
        tm.assert_extension_array_equal(result, expected)
        result[0] = pd.NA
        tm.assert_extension_array_equal(a, pd.array([0, 1, 2, None, None, None], dtype='Float64'))
        tm.assert_extension_array_equal(b, pd.array([0, 1, None, 0, 1, None], dtype='Float64'))
