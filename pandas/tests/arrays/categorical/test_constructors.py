...
import pandas as pd
from pandas import Categorical, CategoricalIndex, DatetimeIndex, Index, Interval, IntervalIndex, MultiIndex, NaT, Series, Timestamp, date_range, period_range, timedelta_range
...
class TestCategoricalConstructors():
    ...
    @pytest.mark.xfail(((not IS64) or is_platform_windows()), reason='Incorrectly raising in ensure_datetime64ns')
