...
import numpy as np
import pytest
from pandas import Categorical, CategoricalIndex, Index, Interval, IntervalIndex, PeriodIndex, Series, Timedelta, Timestamp
...
class TestContains():
    ...
    @pytest.mark.parametrize('item, expected', [(Interval(0, 1), True), (1.5, True), (Interval(0.5, 1.5), False), ('a', False), (Timestamp(1), False), (Timedelta(1), False)], ids=str)
