...
class TestPartialSetting():
    ...
    @pytest.mark.parametrize('idx,labels,expected_idx', [(period_range(start='2000', periods=20, freq='D'), ['2000-01-04', '2000-01-08', '2000-01-12'], [Period('2000-01-04', freq='D'), Period('2000-01-08', freq='D'), Period('2000-01-12', freq='D')]), (date_range(start='2000', periods=20, freq='D'), ['2000-01-04', '2000-01-08', '2000-01-12'], [Timestamp('2000-01-04', freq='D'), Timestamp('2000-01-08', freq='D'), Timestamp('2000-01-12', freq='D')]), (pd.timedelta_range(start='1 day', periods=20), ['4D', '8D', '12D'], [pd.Timedelta('4 day'), pd.Timedelta('8 day'), pd.Timedelta('12 day')])])
    ...
    @pytest.mark.parametrize('idx,labels,msg', [(period_range(start='2000', periods=20, freq='D'), ['4D', '8D'], "None of \\[Index\\(\\['4D', '8D'\\], dtype='object'\\)\\] are in the \\[index\\]"), (date_range(start='2000', periods=20, freq='D'), ['4D', '8D'], "None of \\[Index\\(\\['4D', '8D'\\], dtype='object'\\)\\] are in the \\[index\\]"), (pd.timedelta_range(start='1 day', periods=20), ['2000-01-04', '2000-01-08'], "None of \\[Index\\(\\['2000-01-04', '2000-01-08'\\], dtype='object'\\)\\] are in the \\[index\\]")])
