...
@pytest.mark.parametrize('indexer', [[0.0, 1.0], np.array([1.0, 2.0], dtype='float64'), np.array([True, False], dtype=object), pd.Index([True, False], dtype=object), pd.array(['a', 'b'], dtype='string')])
