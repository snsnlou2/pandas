...
class TestMultiIndexPartial():
    ...
    @pytest.mark.parametrize('indexer, exp_idx, exp_values', [(slice('2019-2', None), [to_datetime('2019-02-01')], [2, 3]), (slice(None, '2019-2'), date_range('2019', periods=2, freq='MS'), [0, 1, 2, 3])])
