...
class TestMultiIndexSlicers():
    ...
    def test_per_axis_per_level_getitem(self):
        ...
        expected = df.loc[[(a, b, c, d) for (a, b, c, d) in df.index.values if (((a == 'A1') or (a == 'A2') or (a == 'A3')) and ((c == 'C1') or (c == 'C3')))]]
        tm.assert_frame_equal(result, expected)
        expected = df.loc[[(a, b, c, d) for (a, b, c, d) in df.index.values if (((a == 'A1') or (a == 'A2') or (a == 'A3')) and ((c == 'C1') or (c == 'C2') or (c == 'C3')))]]
        ...
        expected = s.loc[[(a, b, c, d) for (a, b, c, d) in s.index.values if (((a == 'A1') or (a == 'A2') or (a == 'A3')) and ((c == 'C1') or (c == 'C3')))]]
    ...
    def test_per_axis_per_level_doc_examples(self):
        ...
        expected = df.loc[[(a, b, c, d) for (a, b, c, d) in df.index.values if ((c == 'C1') or (c == 'C3'))]]
        tm.assert_frame_equal(result, expected)
    ...
    def test_loc_axis_single_level_multi_col_indexing_multiindex_col_df(self):
        df = DataFrame(np.arange(27).reshape(3, 9), columns=pd.MultiIndex.from_product([['a1', 'a2', 'a3'], ['b1', 'b2', 'b3']]))
    ...
    def test_loc_slice_negative_stepsize(self):
        ...
        expected = DataFrame([[3, 4], [1, 2]], index=MultiIndex.from_tuples([('a', 1), ('a', 0)]))
        tm.assert_frame_equal(result, expected)
