...
class TestnanopsDataFrame():
    ...
    def test_nansem(self, ddof, skipna):
        ...
        with np.errstate(invalid='ignore'):
            self.check_funs(nanops.nansem, sem, skipna, allow_complex=False, allow_date=False, allow_tdelta=False, allow_obj='convert', ddof=ddof)
...
class TestNanvarFixedValues():
    ...
    def test_nanvar_all_finite(self):
        ...
        tm.assert_almost_equal(actual_variance, self.variance, rtol=0.01)
    ...
    def test_nanstd_nans(self):
        ...
        tm.assert_almost_equal(actual_std, (self.variance ** 0.5), rtol=0.01)
    ...
    def test_nanvar_axis(self):
        ...
        tm.assert_almost_equal(actual_variance, np.array([self.variance, (1.0 / 12)]), rtol=0.01)
