...
class TestPDApi(Base):
    ...
    lib = ['api', 'arrays', 'compat', 'core', 'errors', 'pandas', 'plotting', 'test', 'testing', 'tseries', 'util', 'options', 'io']
    deprecated_modules = ['np', 'datetime']
    misc = ['IndexSlice', 'NaT', 'NA']
    classes = ['Categorical', 'CategoricalIndex', 'DataFrame', 'DateOffset', 'DatetimeIndex', 'ExcelFile', 'ExcelWriter', 'Float64Index', 'Flags', 'Grouper', 'HDFStore', 'Index', 'Int64Index', 'MultiIndex', 'Period', 'PeriodIndex', 'RangeIndex', 'UInt64Index', 'Series', 'SparseDtype', 'StringDtype', 'Timedelta', 'TimedeltaIndex', 'Timestamp', 'Interval', 'IntervalIndex', 'CategoricalDtype', 'PeriodDtype', 'IntervalDtype', 'DatetimeTZDtype', 'BooleanDtype', 'Int8Dtype', 'Int16Dtype', 'Int32Dtype', 'Int64Dtype', 'UInt8Dtype', 'UInt16Dtype', 'UInt32Dtype', 'UInt64Dtype', 'Float32Dtype', 'Float64Dtype', 'NamedAgg']
    deprecated_classes = []
    deprecated_classes_in_future = ['SparseArray']
    modules = []
    funcs = ['array', 'bdate_range', 'concat', 'crosstab', 'cut', 'date_range', 'interval_range', 'eval', 'factorize', 'get_dummies', 'infer_freq', 'isna', 'isnull', 'lreshape', 'melt', 'notna', 'notnull', 'offsets', 'merge', 'merge_ordered', 'merge_asof', 'period_range', 'pivot', 'pivot_table', 'qcut', 'show_versions', 'timedelta_range', 'unique', 'value_counts', 'wide_to_long']
    funcs_option = ['reset_option', 'describe_option', 'get_option', 'option_context', 'set_option', 'set_eng_float_format']
    funcs_read = ['read_clipboard', 'read_csv', 'read_excel', 'read_fwf', 'read_gbq', 'read_hdf', 'read_html', 'read_json', 'read_pickle', 'read_sas', 'read_sql', 'read_sql_query', 'read_sql_table', 'read_stata', 'read_table', 'read_feather', 'read_parquet', 'read_orc', 'read_spss']
    funcs_json = ['json_normalize']
    funcs_to = ['to_datetime', 'to_numeric', 'to_pickle', 'to_timedelta']
    deprecated_funcs_in_future = []
    deprecated_funcs = []
    private_modules = ['_config', '_hashtable', '_lib', '_libs', '_np_version_under1p17', '_np_version_under1p18', '_is_numpy_dev', '_testing', '_tslib', '_typing', '_version']
