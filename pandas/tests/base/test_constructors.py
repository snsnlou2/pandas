...
@pytest.fixture(params=[Series, (lambda x, **kwargs: DataFrame({'a': x}, **kwargs)['a']), (lambda x, **kwargs: DataFrame(x, **kwargs)[0]), Index], ids=['Series', 'DataFrame-dict', 'DataFrame-array', 'Index'])
