...
from pandas.core.arrays import DatetimeArray, IntervalArray, PandasArray, PeriodArray, SparseArray, TimedeltaArray

class TestToIterable():
    dtypes = [('int8', int), ('int16', int), ('int32', int), ('int64', int), ('uint8', int), ('uint16', int), ('uint32', int), ('uint64', int), ('float16', float), ('float32', float), ('float64', float), ('datetime64[ns]', Timestamp), ('datetime64[ns, US/Eastern]', Timestamp), ('timedelta64[ns]', Timedelta)]
...
@pytest.mark.parametrize('array, expected', [(np.array([1, 2], dtype=np.int64), np.array([1, 2], dtype=np.int64)), (pd.Categorical(['a', 'b']), np.array(['a', 'b'], dtype=object)), (pd.core.arrays.period_array(['2000', '2001'], freq='D'), np.array([pd.Period('2000', freq='D'), pd.Period('2001', freq='D')])), (pd.array([0, np.nan], dtype='Int64'), np.array([0, pd.NA], dtype=object)), (IntervalArray.from_breaks([0, 1, 2]), np.array([pd.Interval(0, 1), pd.Interval(1, 2)], dtype=object)), (SparseArray([0, 1]), np.array([0, 1], dtype=np.int64)), (DatetimeArray(np.array(['2000', '2001'], dtype='M8[ns]')), np.array(['2000', '2001'], dtype='M8[ns]')), (DatetimeArray(np.array(['2000-01-01T06:00:00', '2000-01-02T06:00:00'], dtype='M8[ns]'), dtype=DatetimeTZDtype(tz='US/Central')), np.array([Timestamp('2000-01-01', tz='US/Central'), Timestamp('2000-01-02', tz='US/Central')])), (TimedeltaArray(np.array([0, 3600000000000], dtype='i8'), freq='H'), np.array([0, 3600000000000], dtype='m8[ns]')), (pd.Categorical(pd.date_range('2016-01-01', periods=2, tz='US/Pacific')), np.array([Timestamp('2016-01-01', tz='US/Pacific'), Timestamp('2016-01-02', tz='US/Pacific')]))])
