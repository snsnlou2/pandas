...
from pandas.plotting._matplotlib.tools import create_subplots, flatten_axes, set_ticks_props
if TYPE_CHECKING:
...
class HistPlot(LinePlot):
    ...
    def _args_adjust(self):
        if is_integer(self.bins):
            ...
            (_, self.bins) = np.histogram(values, bins=self.bins, range=self.kwds.get('range', None))
...
def _grouped_plot(plotf, data, column=None, by=None, numeric_only=True, figsize=None, sharex=True, sharey=True, layout=None, rot=0, ax=None, **kwargs):
    if (figsize == 'default'):
...
def _grouped_hist(data, column=None, by=None, ax=None, bins=50, figsize=None, layout=None, sharex=False, sharey=False, rot=90, grid=True, xlabelsize=None, xrot=None, ylabelsize=None, yrot=None, legend=False, **kwargs):
    ...
    fig.subplots_adjust(bottom=0.15, top=0.9, left=0.1, right=0.9, hspace=0.5, wspace=0.3)
    return axes

def hist_series(self, by=None, ax=None, grid=True, xlabelsize=None, xrot=None, ylabelsize=None, yrot=None, figsize=None, bins=10, legend=False, **kwds):
...
def hist_frame(data, column=None, by=None, grid=True, xlabelsize=None, xrot=None, ylabelsize=None, yrot=None, ax=None, sharex=False, sharey=False, figsize=None, layout=None, bins=10, legend=False, **kwds):
    if (legend and ('label' in kwds)):
        raise ValueError('Cannot use both legend and label')
    if (by is not None):
