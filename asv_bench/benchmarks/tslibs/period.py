...
class PeriodProperties():
    params = (['M', 'min'], ['year', 'month', 'day', 'hour', 'minute', 'second', 'is_leap_year', 'quarter', 'qyear', 'week', 'daysinmonth', 'dayofweek', 'dayofyear', 'start_time', 'end_time'])
...
_freq_ints = [1000, 1011, 2000, 2011, 3000, 4000, 4006, 5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000]

class TimePeriodArrToDT64Arr():
    params = [_sizes, _freq_ints]
