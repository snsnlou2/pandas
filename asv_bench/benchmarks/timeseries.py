...
import dateutil
import numpy as np
from pandas import DataFrame, Series, date_range, period_range, timedelta_range, to_datetime
...
class ResampleSeries():
    ...
    def setup(self, index, freq, method):
        indexes = {'period': period_range(start='1/1/2000', end='1/1/2001', freq='T'), 'datetime': date_range(start='1/1/2000', end='1/1/2001', freq='T')}
        idx = indexes[index]
...
class ResampleDatetetime64():
    ...
    def setup(self):
        rng3 = date_range(start='2000-01-01 00:00:00', end='2000-01-01 10:00:00', freq='555000U')
